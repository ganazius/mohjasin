...
$html = '<!DOCTYPE html>
        <html>
        <head>
          	<title>Laporan Data Dulur</title>
          	<link rel="stylesheet" href="../../assets/css/laporan.css">
        </head>
        <body>
			<div class="text-center">
				<h1>LAPORAN DATA DULUR</h1>
...
$query = mysqli_query($mysqli, "SELECT * FROM tbl_dulur 
                                WHERE tanggal_isi BETWEEN '$tgl_awal' AND '$tgl_akhir'
                                ORDER BY id_dulur ASC")
...
$html .= '    		</tbody>
          	...
          	<div class="text-right mt-5">Jepara, ' . tanggal_indo(date('Y-m-d')) . '</div>
        </body>
        </html>';
